    ...
    <div>
      <div id="footer">
        <div class="cta-block style-two">
          <div class="bg-cta w-100">
            <img
              class="w-100 h-100"
              src="assets/images/cta/bg-cta1.png"
              alt=""
            />
          </div>
              ...
              <div class="row flex-between pb-40">
                <div class="col-3">
                  <div class="footer-company-infor flex-columns-between gap-20">
                    <img
                      class="footer-logo"
                      src="assets/images/BlackSun.png"
                      alt="Logo"
                    />
                    <div class="text caption1 text-white">
                    We are a company specializing in providing comprehensive accounting and tax solutions for businesses in the Vietnamese market.
                ...
                <div class="col-6">
                  <div class="footer-navigate flex-center gap-80">
                    <div class="footer-nav-item">
                      <div class="item-heading text-button-small text-white">
                        Quick Links
                      </div>
                ...
                <div class="col-3">
                  <div class="company-contact">
                    <div class="heading text-button-small text-white">
                      Newsletter
                    </div>
                    <div class="mt-12 flex-item-center">
                      ...
                      <div class="text ml-16">
                        ...
                        <div class="fw-700 text-white mt-4">0868-489-997</div>
                      </div>
                    </div>
                    <div class="locate mt-12 flex-item-center">
                      {" "}
                      <i class="ph-light ph-map-pin text-line"></i>
                      <div class="caption1 text-line ml-8">
                        G1 Vinhomes Greenbay, Nam Tu Liem, Ha Noi, Viet Nam
                      </div>
                    </div>
              ...
              <div class="footer-bottom flex-between pt-12 pb-12">
                <div class="left-block flex-item-center">
                  <div class="copy-right text-line caption1">
                    ©2024 Blacksun. All Rights Reserved.
                  </div>
                </div>
                <div class="nav-link flex-item-center gap-10">
                  <a class="text-line caption1 hover-underline" href="#!">
                    Terms Of Services
                  </a>
